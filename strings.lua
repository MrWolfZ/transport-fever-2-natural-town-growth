  ...
  return {
    en = {
      ...
      Description = 'Towns grow more naturally. Your actions will influence the growth directly and can cause towns to grow '
                 ...
                 .. 'in reachability, supply, or environmental factors still affects all sizes.\n'
                 .. '\n'
                 .. 'When you start a new game (or enable the mod for an existing game) it will take some time for towns to adjust '
                 .. 'to their new sizes (for a new game it should take about 1 year, for existing games longer depending on your '
                 .. 'progress). Please also note that the game seems to have a built-in limit to how large towns can grow, so at '
                 .. 'some point you may see a town stop growing regardless of the "target size".\n'
                 .. '\n'
                 .. 'See the last image above for a detailed look into the numbers. Note that the "scaling factors" are only used for '
                 .. 'the base capacity, meaning their impact decreases over time once you start connecting the city and supplying '
                 .. 'it with cargo.\n'
                 .. '\n'
    ...
    de = {
      ...
      Description = 'Städte wachsen natürlicher. Deine Handlungen beeinflussen das Wachstum der Städte direkt und können dazu führen, '
                 ...
                 .. 'Umwelteinflüssen hat weiterhin einen Effekt auf alle Bereiche.\n'
                 .. '\n'
                 .. 'Wenn du ein neues Spiel beginnst (oder die Mod für ein existierendes Spiel aktivierst) wird es etwas dauern bis sich '
                 .. 'die Städte an ihre neue Grösse angepasst haben (für neue Spiele dauert es ungefähr ein Jahr, bei existierenden Spielen '
                 .. 'variiert es abhängig von deinem Fortschritt). Bitte beachte auch, dass das Spiel anscheinend ein eingebautes '
                 .. 'Grössenlimit hat und daher kann es sein, dass Städte aufhören zu wachsen, selbst wenn das Spiel einen grösseren '
                 .. 'Zielwert angibt.\n'
                 .. '\n'
